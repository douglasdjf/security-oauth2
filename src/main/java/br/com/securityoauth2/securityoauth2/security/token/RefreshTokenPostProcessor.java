 ...
 *
 * Lembrando que é possível interceptar qualquer tipo de ResponseBody neste caso vai ser utilizado o OAuth2AccessToken
 *
 *
 */
@ControllerAdvice
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken> {
    ...
    /**
     *
     * Verificando se o retorno do método é postAccessToken
     */
    @Override
    ...
    /**
     * Adicionando o refreshToken no Cookie e Remover do Body
     */
    @Override
    ...
    /**
     *  Método que adiciona o refreshToken na requisição
     * @param refreshToken
     * @param req
     * @param resp
     */
